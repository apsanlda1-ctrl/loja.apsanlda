...
function boot(){background();load('apsanAccountRegistrationFix','js/account-registration-fix.js?v=20260908b');load('apsanPhysicalProductScript','js/physical-product-flow.js?v=20260908e');load('apsanSellerSalesHubScript','js/seller-sales-hub.js?v=20260908e');load('apsanSellerRuntimeFix','js/seller-hub-runtime-fix.js?v=20260908e')}
