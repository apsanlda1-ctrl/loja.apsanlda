/* APSAN — fluxo de saques V7
   Fluxo: saldo líquido aprovado -> professor escolhe montante -> pedido
   -> aprovação/processamento administrativo -> confirmação da transferência.
   Camada adicional: não substitui dados nem apaga funções existentes.
*/
(function(){
  'use strict';
